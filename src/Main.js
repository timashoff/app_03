...
export function Main() {
  return (
    <section>
      <img src="./rasp.jpeg" alt="rasp" className="main--photo" />
      ...
      <img src="./rasp_01.jpg" alt="rasp" className="big--photo, big--photo01" />
      <img src="./rasp_02.jpg" alt="rasp" className="big--photo" />
      <p>
